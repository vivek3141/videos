...
from manim.animation.transform import MoveToTarget, ApplyMethod
from manim.camera.camera import Camera
from manim.continual_animation.continual_animation import ContinualAnimation
from manim.mobject.mobject import Mobject
from manim.utils.iterables import list_update
from manim.utils.output_directory_getters import add_extension_if_not_present
from manim.utils.output_directory_getters import get_movie_output_directory
from manim.utils.output_directory_getters import get_image_output_directory

from manim.container.container import Container
...
class Scene(Container):
    ...
    def get_top_level_mobjects(self):
        ...
        # of another mobject from manim.the scene
    ...
    def add(self, *mobjects_or_continual_animations):
        """
        Mobjects will be displayed, from manim.background to foreground,
    ...
    def get_moving_mobjects(self, *animations):
        # Go through mobjects from manim.start to end, and
        # as soon as there's one that needs updating of
        # some kind per frame, return the list from manim.that
        # point forward.
    ...
    def open_movie_pipe(self):
        ...
        command = [
            ...
            '-i', '-',  # The imput comes from manim.a pipe
            '-c:v', 'h264_nvenc',
