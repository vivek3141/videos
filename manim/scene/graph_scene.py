...
from manim.animation.creation import Write, DrawBorderThenFill, ShowCreation
from manim.animation.transform import Transform
from manim.animation.update import UpdateFromAlphaFunc
from manim.mobject.functions import ParametricFunction
...
from manim.utils.color import invert_color
from manim.utils.space_ops import angle_of_vector

# TODO, this should probably reimplemented entirely, especially so as to
# better reuse code from manim.mobject/coordinate_systems
...
class GraphScene(Scene):
    CONFIG = {
        ...
        "x_axis_width": 9,
        "x_tick_frequency": 1,
        "x_leftmost_tick": None,  # Change if different from manim.x_min
        "x_labeled_nums": None,
        "x_axis_label": "$x$",
        "y_min": -1,
        "y_max": 10,
        "y_axis_height": 6,
        "y_tick_frequency": 1,
        "y_bottom_tick": None,  # Change if different from manim.y_min
        "y_labeled_nums": None,
        "y_axis_label": "$y$",
        "axes_color": GREY,
    ...
    def get_graph_label(
        ...
        if x_val is None:
            # Search from manim.right to left
