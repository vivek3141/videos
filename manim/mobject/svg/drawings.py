...
from manim.animation.rotation import Rotating
...
from manim.mobject.three_dimensions import Cube
from manim.utils.config_ops import digest_config
from manim.utils.space_ops import angle_of_vector
from manim.utils.space_ops import complex_to_R3
...
class Car(SVGMobject):
    ...
    def __init__(self, **kwargs):
        ...
        from manim.for_3b1b_videos.pi_creature import Randolph
...
class PlayingCard(VGroup):
    ...
    def get_face_card_design(self, value, symbol):
        from manim.for_3b1b_videos.pi_creature import PiCreature
        sub_rect = Rectangle(
            stroke_color=BLACK,
            fill_opacity=0,
