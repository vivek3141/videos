...
from manim.utils.simple_functions import get_num_args
...
class Mobject(Container):
    ...
    def add_background_rectangle(self, color=BLACK, opacity=0.75, **kwargs):
        ...
        from manim.mobject.shape_matchers import BackgroundRectangle
    ...
    def get_point_mobject(self, center=None):
        """
        The simplest mobject to be transformed to or from manim.self.
